#!/usr/bin/env python3
"""Página — Mercado Oncológico: Fornecedores e Preço (concentração, desconto e ticket por classe farmacológica).
Espelha analise/views/mercado_fornecedores.py."""

import plotly.express as px
import streamlit as st

from dashboard_common_onco import CORES_CLASSE_FARMACO, fmt_abrev, fundo_transparente, para_mil, preparar_pagina_onco
...
with col_desc_cat:
    st.subheader("Desconto mediano por classe farmacológica")
    ...
    if preco.empty:
        ...
        fig4 = px.bar(
            ...
            color="categoria", color_discrete_map=CORES_CLASSE_FARMACO,
            labels={"categoria": "Classe farmacológica", "desconto_pct": "Desconto mediano (%)"},
...
with col_ticket_cat:
    st.subheader("Valor médio por item, por classe farmacológica")
    ...
    fig5 = px.bar(
        ...
        color="categoria", color_discrete_map=CORES_CLASSE_FARMACO,
        labels={"categoria": "Classe farmacológica", "valor_medio": "Valor médio por item (R$)"},
